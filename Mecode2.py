...
# Create our addin definition object
    ...
    my_addin.add_command(
        ...
        SamplePaletteShowCommand,
        {
            ...
            'palette_html_file_url': 'palette_html/Mecode2.html',
    ...
    # my_addin.add_custom_event("Mecode2_message_system", SampleCustomEvent1)

    # my_addin.add_document_event("Mecode2_open_event", app.documentActivated, SampleDocumentEvent1)
    # my_addin.add_document_event("Mecode2_close_event", app.documentClosed, SampleDocumentEvent2)

    # my_addin.add_workspace_event("Mecode2_workspace_event", ui.workspaceActivated, SampleWorkspaceEvent1)

    # my_addin.add_web_request_event("Mecode2_web_request_event", app.openedFromURL, SampleWebRequestOpened)

    # my_addin.add_command_event("Mecode2_command_event", app.userInterface.commandStarting, SampleCommandEvent)
